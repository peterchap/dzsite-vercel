...
function ReportPreview() {
  return (
    <div className="relative pt-4 pl-4">
      <div className="absolute left-0 top-0 h-full w-full rounded-[1.75rem] border border-white/10 bg-white/[0.035]" />
      <div className="absolute left-2 top-2 h-full w-full rounded-[1.75rem] border border-white/10 bg-white/[0.045]" />
      <div className="relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-[#030619]/90 p-5 shadow-2xl shadow-black/30">
        ...
        <div className="relative">
          <div className="flex items-start justify-between gap-4 border-b border-white/10 pb-4">
            ...
            <div className="grid gap-2 text-right">
              <div className="rounded-full border border-cyan-300/25 bg-cyan-300/[0.08] px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-cyan-100">
                Multi-page
              </div>
