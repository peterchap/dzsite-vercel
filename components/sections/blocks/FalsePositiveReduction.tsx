                ...
                <div className="grid gap-0 lg:grid-cols-2 lg:items-center">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            <h2 className="text-3xl font-bold tracking-tight text-white md:text-4xl leading-tight">
                                {headline}
                            </h2>
                        ...
                        <div className="grid gap-6 sm:grid-cols-2">
                            ...
                            <div className="rounded-2xl border border-blue-100 bg-blue-50/30 p-6 shadow-sm">
                                ...
                                <p className="text-sm text-slate-300 leading-relaxed">{solutionSnippet?.content}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative flex items-center justify-center lg:justify-start lg:translate-x-[25px] lg:translate-y-10">
                        <div className="w-full max-w-[85%]">
                            {image && (
                                <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950 shadow-2xl transition hover:shadow-blue-500/10">
                                    <Image
