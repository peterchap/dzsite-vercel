            ...
            <Container>
                <div className={`grid gap-12 ${gridClass} lg:items-center`}>
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    {approaches?.map((approach, i) => (
                                        <div key={i} className="flex gap-3">
                                            ...
                                            <div>
                                                <span className="block font-bold text-white">{approach.label}:</span>
                                                <span className="text-sm text-slate-300">{approach.text}</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                    ...
                    <div className="relative w-full scale-95 lg:scale-100">
                        {visual && (
                            <div className="overflow-hidden rounded-3xl border border-white/10 bg-slate-950 p-2 shadow-2xl">
                                <Image
