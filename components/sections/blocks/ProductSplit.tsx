    ...
    <section className={`py-12 ${'bg-slate-950'}`}>
      <div className="mx-auto max-w-6xl px-6">
        <div className="max-w-3xl text-center mx-auto">
          <h2 className="text-3xl font-semibold tracking-tight text-white text-center">{title}</h2>
          {subtitle && (
        ...
        <div className={`mt-10 grid gap-6 ${center ? 'lg:grid-cols-3 md:grid-rows-[auto_1fr_auto_auto]' : 'lg:grid-cols-2 md:grid-rows-[auto_1fr_auto_auto]'}`}>
          {/* Left Column */}
          <div className="group relative flex flex-col overflow-hidden rounded-3xl border border-white/10 bg-slate-950/80 p-8 shadow-sm backdrop-blur transition hover:-translate-y-0.5 hover:shadow-md md:grid md:grid-rows-subgrid md:row-span-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="mt-1 text-xl font-semibold text-white">{left.heading}</h3>
              </div>
            </div>
            <div className="flex flex-col">
              <p className="mt-4 whitespace-pre-line text-slate-300">{left.body}</p>
            </div>
          ...
          {center ? (
            <div className="group relative flex flex-col overflow-hidden rounded-3xl border border-white/10 bg-slate-950/80 p-8 shadow-sm backdrop-blur transition hover:-translate-y-0.5 hover:shadow-md md:grid md:grid-rows-subgrid md:row-span-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="mt-1 text-xl font-semibold text-white">{center.heading}</h3>
                </div>
              </div>
              <div className="flex flex-col">
                <p className="mt-4 whitespace-pre-line text-slate-300">{center.body}</p>
              </div>
              <div className="flex flex-col">
                {center.integrationLine ? (
                  <div className="mt-4 flex items-start gap-2 rounded-2xl border border-white/10 bg-white/5 p-4">
                    ...
                    <p className="text-sm text-slate-300">{center.integrationLine}</p>
                  </div>
                ) : (
                  <div className="invisible h-0 md:h-auto" aria-hidden="true" />
                )}
          ...
          <div className="group relative flex flex-col overflow-hidden rounded-3xl border border-white/10 bg-slate-950/80 p-8 shadow-sm backdrop-blur transition hover:-translate-y-0.5 hover:shadow-md md:grid md:grid-rows-subgrid md:row-span-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="mt-1 text-xl font-semibold text-white">{right.heading}</h3>
              </div>
            </div>
            <div className="flex flex-col">
              <p className="mt-4 whitespace-pre-line text-slate-300">{right.body}</p>
            </div>
            <div className="flex flex-col">
              {right.integrationLine ? (
                <div className="mt-4 flex items-start gap-2 rounded-2xl border border-white/10 bg-white/5 p-4">
                  <PlugZap className="mt-0.5 h-4 w-4 text-blue-600" />
                  <p className="text-sm text-slate-300">{right.integrationLine}</p>
                </div>
              ) : (
                <div className="invisible h-0 md:h-auto" aria-hidden="true" />
              )}
