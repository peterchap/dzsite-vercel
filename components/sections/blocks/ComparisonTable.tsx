                    ...
                    {columns.map((col) => (
                        <div
                            ...
                            className={`flex flex-col p-8 rounded-2xl border transition-all duration-300 ${col.isHighlight
                                ? "bg-slate-950 border-blue-500 shadow-xl relative overflow-hidden z-10 scale-105"
                                : "bg-slate-950 border-white/10 shadow-sm hover:border-blue-200"
                                }`}
                        >
                            {col.isHighlight && (
                                <div className="absolute top-0 inset-x-0 h-1.5 bg-blue-500" />
                            )}
                            <h3 className={`text-xl font-bold mb-6 ${col.isHighlight ? "text-blue-600" : "text-white"}`}>
                                {col.heading}
                            </h3>
