      ...
      <Container>
        <div>
          <div className="mx-auto max-w-3xl text-center">
            ...
            {title && (
              <h2 className="mt-2 text-3xl font-semibold tracking-tight text-white text-center">
                {title}
              </h2>
            )}
            {subtitle && (
          ...
          <div className="mt-10 rounded-3xl border border-white/10 bg-slate-950/80 p-8 shadow-sm backdrop-blur overflow-x-auto">
            <div
