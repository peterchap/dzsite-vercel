            ...
            <Container>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:hidden">
                    {displayItems.map((item, i) => (
                        <div key={i} className="bg-slate-950 p-6 rounded-2xl border border-white/10 shadow-sm">
                ...
                <div className="hidden lg:block relative h-[600px] w-full max-w-[900px] mx-auto">
                    ...
                    {displayItems.map((item, i) => {
                        ...
                        return (
                            ...
                            >
                                <div className="bg-slate-950 p-4 rounded-2xl border border-white/10 shadow-lg hover:shadow-xl hover:border-blue-200 transition-all">
                                    ...
                                    <ul className="space-y-1">
                                        {item.features?.map((f, fi) => (
                                            <li key={fi} className="flex items-start gap-2 text-[12px] text-slate-300 leading-snug">
