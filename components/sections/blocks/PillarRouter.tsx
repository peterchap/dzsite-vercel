            ...
            <Container>
                {(title || subtitle) && (
                    <div className="max-w-3xl mb-20 text-center mx-auto">
                        ...
                        {subtitle && <p className="mt-6 text-xl text-slate-400 leading-relaxed">{subtitle}</p>}
                    </div>
                )}
                    ...
                    {pillars?.map((pillar: any, i: number) => {
                        ...
                        return (
                            <a
                                ...
                                className="group relative flex flex-col items-start p-10 rounded-[2.5rem] border border-white/10 bg-slate-950 shadow-sm transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 overflow-hidden"
                            >
