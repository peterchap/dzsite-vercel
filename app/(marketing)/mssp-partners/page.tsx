    ...
    <ProductConceptPage
        ...
        types: [
          {
            ...
            evidence: [
              ...
              "Machine-consumable feed for AI agents, SIEM, SOAR, scoring systems and blocklists",
              "Human-readable evidence for analyst review, customer explanation and audit trail",
            ],
          },
          {
          ...
          },
          {
            ...
            evidence: [
              ...
              "Structured JSON outputs for automated pipelines and AI agents",
              "Reasoning fields for explainability and customer trust",
              "Cloud-native data products for partner analytics and enrichment",
            ],
          },
        ],
      ...
      exampleAlert={{
        ...
        fields: [
          ...
          { label: "Confidence", value: "Score and reason codes available for thresholding" },
          { label: "Commercial impact", value: "Lower triage time and more scalable managed detection" },
        ],
        reasons: [
          "Early internet infrastructure signal observed before campaign maturity",
          "Reason codes explain why the alert should be trusted",
          "Structured feed supports automated blocking and AI-agent workflows",
          "Analysts receive context only when review is required",
        ],
