            ...
            <div className="mx-auto max-w-6xl px-6 py-12 lg:py-16">
                <div className="mx-auto max-w-3xl space-y-12">
                    ...
                    <LegalSection title="3. Acceptable Use">
                        ...
                        <p className="mt-4 font-semibold text-white">You must not:</p>
                    ...
                    <LegalSection title="4. Data Nature and Limitations">
                        ...
                        <p className="mt-4 font-semibold text-white">You acknowledge that:</p>
                        <ul className="mt-3 list-disc pl-5 space-y-2 text-slate-300">
                    ...
                    <LegalSection title="5. Beta and Early Access Services">
                        ...
                        <div className="mt-6 p-6 rounded-2xl bg-amber-500/10 border border-amber-400/25">
                            <h4 className="font-bold text-amber-200 mb-3">Beta Services Notice:</h4>
                            <ul className="list-disc pl-5 space-y-2 text-amber-100/90 text-sm">
                    ...
                    <LegalSection title="10. Disclaimer of Warranties">
                        <div className="bg-white/[0.04] border border-white/10 text-slate-200 p-8 rounded-3xl font-mono text-sm uppercase tracking-tight leading-relaxed">
                    ...
                    <LegalSection title="11. Limitation of Liability">
                        <p className="font-semibold text-white">To the maximum extent permitted by law:</p>
                        <ul className="mt-3 list-disc pl-5 space-y-4 text-slate-300">
...
function ContactCard({ title, value, href }: { title: string; value: string; href: string }) {
    return (
        <a
            href={href}
            className="group p-5 rounded-2xl border border-white/10 bg-white/[0.035] shadow-sm hover:border-blue-400/40 transition-colors block"
        >
