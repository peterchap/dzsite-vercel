...
// Copy only. Structural/transactional fields (tier accent classes, catalog
...
export const content: PageContent = {
  ...
  anatomy: {
    ...
    items: [
      ...
      { key: "ce-calendar", title: "Operational calendar & exception register", text: "What expires next, what's already lapsed, and a single prioritized list of what to act on, in order." },
  ...
  sampleFindings: {
    ...
    title: "The report explains threat context, defense gaps and what to fix next.",
  ...
  upgradePaths: {
    ...
    body: "The free report gives the single-domain baseline. Paid reports add estate-wide coverage, systemic risk analysis and recurring reporting across the domains an organization owns.",
    items: [
