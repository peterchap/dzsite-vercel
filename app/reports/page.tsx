    ...
    types: [
      {
        ...
        evidence: ["DMARC enforcement status and policy posture", "SPF and DKIM presence and alignment checks", "MX provider and mail platform inference", "Suggested remediation steps for weak or missing controls"],
      },
      {
        ...
        evidence: ["Detected mail, cloud, CDN and hosting providers", "SaaS and platform indicators from DNS and infrastructure patterns", "Vendor and supplier infrastructure signals", "Context for platform-led impersonation monitoring"],
      },
      {
        ...
        evidence: ["Platform or brand impersonation context", "Suspicious domain, certificate, DNS or hosting signals", "Risk-ranked remediation recommendations", "Suggested upgrade path into real-time alerts or portfolio monitoring"],
      },
    ],
...
export default async function ReportsPage() {
  const cmsContent = await sanityFetch<ProductConceptPageProps | null>(productConceptPageBySlugQuery, { slug: "reports" });
